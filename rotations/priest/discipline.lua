...
local SB = bxhnz7tp5bge7wvu.rotation.spellbooks.priest

local function combat()

    local dispellable_unit = group.removable('disease', 'magic')
    local buffable_unit = group.buffable(SB.PowerWordShield)
    local callpet = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_callpet', false)
    local multinumber = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_multi', 1)
    local usepws = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_pwsuse', 90)
    local usehealthstone = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_healthstone.check', false)
    local healthstonepercent = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_healthstone.spin', 20)
    local intpercent = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_spinner', 75)
    local halopercentuse = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_halopercent', 75)
    local nameplates = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_usenameplates', false)
...
local function resting()
   local healthstonepercent = bxhnz7tp5bge7wvu.settings.fetch('dr_disc_healthstone.spin') 
...
local discgui = {
  ...
  configWindow = bxhnz7tp5bge7wvu.interface.builder.buildGUI(discgui)
    ...
    on = {
      ...
      color2 = bxhnz7tp5bge7wvu.interface.color.ratio(bxhnz7tp5bge7wvu.interface.color.blue, 0.7)
    },
    off = {
      label = 'Dung',
  ...
  bxhnz7tp5bge7wvu.interface.buttons.add_toggle({
    ...
    on = {
      ...
      color2 = bxhnz7tp5bge7wvu.interface.color.ratio(bxhnz7tp5bge7wvu.interface.color.red, 0.7)
    },
    off = {
      label = 'dsp',
      color = bxhnz7tp5bge7wvu.interface.color.grey,
...
bxhnz7tp5bge7wvu.rotation.register({
  spec = bxhnz7tp5bge7wvu.rotation.classes.priest.discipline,
  name = 'disc',
