...
local TB = bxhnz7tp5bge7wvu.rotation.talentbooks.paladin
...
bxhnz7tp5bge7wvu.environment.hook(finishers)
...
function interface()
  bxhnz7tp5bge7wvu.interface.buttons.add_toggle({
    ...
    on = {
      label = bxhnz7tp5bge7wvu.interface.icon('bars'),
...
bxhnz7tp5bge7wvu.rotation.register('retribution', combat, resting, interface)
