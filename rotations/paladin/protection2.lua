...
local SB = bxhnz7tp5bge7wvu.rotation.spellbooks.paladin
...
function interface()
    ...
    on = {
      label = bxhnz7tp5bge7wvu.interface.icon('award'),
      color = bxhnz7tp5bge7wvu.interface.color.blue,
      color2 = bxhnz7tp5bge7wvu.interface.color.ratio(bxhnz7tp5bge7wvu.interface.color.purple, 0.7)
    },
    off = {
      label = bxhnz7tp5bge7wvu.interface.icon('award'),
    ...
    font = 'bxhnz7tp5bge7wvu_icon',
    on = {
      label = bxhnz7tp5bge7wvu.interface.icon('crown'),
      color = bxhnz7tp5bge7wvu.interface.color.blue,
      color2 = bxhnz7tp5bge7wvu.interface.color.ratio(bxhnz7tp5bge7wvu.interface.color.purple, 0.7)
    },
    off = {
...
bxhnz7tp5bge7wvu.rotation.register({
  spec = bxhnz7tp5bge7wvu.rotation.classes.paladin.protection,
  name = 'protection2',
  label = ' by Laksmackt',
  combat = combat,
  resting = resting,
