...
local DB = bxhnz7tp5bge7wvu.rotation.dispellbooks.druid
local DS = bxhnz7tp5bge7wvu.rotation.dispellbooks.soothe
...
bxhnz7tp5bge7wvu.rotation.register({
  spec = bxhnz7tp5bge7wvu.rotation.classes.druid.restoration,
  name = 'restoration',
