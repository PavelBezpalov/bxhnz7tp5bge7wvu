...
local SB = bxhnz7tp5bge7wvu.rotation.spellbooks.shaman
...
local function combat()
  ...
  -- get our GUI eadings
   local lavauseperc = bxhnz7tp5bge7wvu.settings.fetch('dr_enhancement_lavause.spin', 90)
    -- Interupts
...
local enhancegui = {
  ...
  configWindow = bxhnz7tp5bge7wvu.interface.builder.buildGUI(enhancegui)
...
bxhnz7tp5bge7wvu.rotation.register({
  spec = bxhnz7tp5bge7wvu.rotation.classes.shaman.enhancement,
  name = 'enhancement',
